...
//                                            
            ...
            function createGridItem(p_EndTagList, p_parentId){
                ...
                $.each(p_EndTagList, function(keyYoujing, valueYoujing){
                    ...
                    if(valueYoujing.major_tag_id == p_parentId && valueYoujing.type == 'YOU_JING'){
                ...
                $.ajax({
                    ...
                    success: function(jsonYoujing){//alert(mapData.get('2013-06-09'));
                        $.each(jsonYoujing,function(keyYoujing, valueYoujing){
                            if(valueYoujing.major_tag_id == p_id){
...
//                                        alert(valueYoujing.date + '---' + p_mapData.get(valueYoujing.date));
             ...
             * @returns {Object}             */
            function createTreeNodeItem(p_treeNodes, p_MajorTagId, p_MajorTagParentIdPrefix){
                        
                $.each(strYoujing,function(keyYoujing, valueYoujing)
                            {
                                if(p_MajorTagId == valueYoujing.major_tag_id){
                                    
                                    var treeNodesItem = new Object();

                                    treeNodesItem.id = p_MajorTagParentIdPrefix + '_yj_' + valueYoujing.id ;
                                    treeNodesItem.pId = p_MajorTagParentIdPrefix;
